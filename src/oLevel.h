...
public:
	...
	{
		string type; // ��� ������
		int chance_type = rand()%tank.max_chance_type_bonus;		// ����������� ���� ������
		// �������� ���� �� ����� ������
		...
		{
			if(chance_type < 10 ) type = "heal";				// �����
			else if(chance_type < 20 ) type = "energy";			// �������
			else if(chance_type < 30 ) type = "experience";		// ����
			else if(chance_type < 40 ) type = "multiple";		// ��
			else if(chance_type < 50 ) type = "overload";		// �������� ��� ������ �������
			else if(chance_type < 60 ) type = "shield";			// ����������
			else if(chance_type < 70 ) type = "power";			// ���������������
			else if(chance_type < 80 ) type = "slow";			// ��������� �������
			else if(chance_type < 90 ) type = "shards";			// �������� ���� �������
			else if(chance_type < 100 ) type = "explosive";		// ������� �����
			else if(chance_type < 110 ) type = "signal_sos";	// ����� � ���������
			else if(chance_type < 120 ) type = "plasm";			// ������ SOS
			else if(chance_type < 130 ) type = "chrono";		// �������� ���������
			else if(chance_type < 140 ) type = "turret";		// ����� �������
			else if(chance_type <= 150 ) type = "blackhole";	// ������ ����
		...
		if(tank.ui.experience.addExp(enemy.GetLevel() * 36)) // ���� ������ �������
		{
			tank.LevelUp();
			// ��������� ��������� ����� ��������� ������ ������
		...
		if(!isWin && !isDefeat)
		{
			...
			for(auto it1 = vec_Enemy.begin(); it1 != vec_Enemy.end();)
			{
				...
				if(!enemy.IsDead())
				{
					...
					for(auto it2 = tank.vec_Missle.begin(); it2 != tank.vec_Missle.end();) // ���� �����
					{
						auto& missle = *(*it2);
						// ���� ���� ����� ������ �� �����
